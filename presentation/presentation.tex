...
Based on NUCOMP, NUDUPL, and NUCUBE \\(Shanks, Atkin, van der Poorten, Jacobson, Imbert, Schmidt, possibly others). % TODO CITE
...
\item 10,000 groups (1000 multiplications, 1000 squares, 1000 cubes).
...
\end{itemize}
Use average time of ideal class arithmetic to estimate the time to exponentiate a 2,3 representation using Yao's algorithm for double-base exponentiation.
\end{frame}
